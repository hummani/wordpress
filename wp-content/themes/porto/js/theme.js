    ...
    $.extend(theme, {
        ...
        Tooltip: {
            ...
            build: function() {
                ...
                // wishlist tooltip
                /*self.$elements.find('.products .yith-wcwl-wishlistexistsbrowse.show, .products .yith-wcwl-wishlistaddedbrowse.show').each(function(){
                 var title = $(this).find('a').text();
                 $(this).find('a').attr('data-title', title).attr('data-toggle', 'tooltip');
                 });
                 self.$elements.find('.products .yith-wcwl-add-button.show').each(function(){
                 var title = $(this).find('a').text();
                 $(this).find('a.add_to_wishlist').attr('data-title', title).attr('data-toggle', 'tooltip');
                 });
                 //quickview, add to cart tooltip
                 self.$elements.find('.products .viewcart, .products .quickview, .products a.compare.button, .products .add_to_cart_read_more, .product .add_to_cart_button').each(function(){
                 var title = $(this).text();
...
(function (theme, $) {
    ...
    $(document).ready(function() {
        ...
        h = function () {
            r = false;
            $(window).trigger('porto_resizeend', e);
        };
        ...
        $(window).on('resize load', function (event) {
            ...
            if (!r) {
                $(window).trigger('porto_resizestart', e);
                r = true;
            }
        ...
        $(window).on('porto_resizeend', function() {
            var $master_sliders = $('body.boxed .master-slider');
            $master_sliders.each(function() {
                var $slider = $(this);
                var max_width = parseFloat($slider.css('max-width'));
                if (!isNaN(max_width)) {
                    $slider.css('max-width', 'none');
                    var width = $slider.width();
                    $slider.css('max-width', '');
                    var margin_left = parseFloat($slider.css('margin-left'));
                    if (!isNaN(width) && !isNaN(margin_left) && width > max_width) {
                        $slider.css('margin-left', (width - max_width) / 2 + margin_left);
                    }
                }
            });
        });*/
