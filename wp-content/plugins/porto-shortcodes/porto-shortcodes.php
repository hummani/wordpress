...
class PortoShortcodesClass {
    ...
    private $shortcodes = array("porto_block", "porto_container", "porto_animation", "porto_testimonial", "porto_content_box", "porto_history", "porto_grid_container", "porto_grid_item", "porto_links_block", "porto_links_item", "porto_recent_posts", "porto_recent_portfolios", "porto_recent_members", "porto_blog", "porto_portfolios", "porto_faqs", "porto_members", "porto_concept", "porto_map_section", "porto_section", "porto_toggles", "porto_blockquote", "porto_tooltip", "porto_popover", "porto_price_boxes", "porto_price_box");
